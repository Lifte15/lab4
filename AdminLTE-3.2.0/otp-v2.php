    ...
    ?>
      <div class="login-box">
        ...
        <div class="card card-outline card-primary">
          ...
          <div class="card-body">
          <h5 class="login-box-msg">Verify a new membership</h5>
          ...
          <?php if (isset($_GET['success'])) { ?>
                <!-- Paragraph with error styling and text from GET parameter -->
                <p class="success text-success text-center"><?php echo $_GET['success']; ?></p>
            <?php } ?>
            <form action="verify.php" method="post">
              ...
              <div class="input-group mb-3">
                <input type="text" name="user_otp" class="form-control" placeholder="Enter OTP to verify email">
                <div class="input-group-append">
                  <div class="input-group-text">
              ...
              <div class="row">
                <div class="col-8">
                  <a href="login-v2.php">I already have a membership</a>
                </div>
                <div class="col-4">
